...
class HomeRepositoryImpl implements BaseHomeRepository {
  ...
  final BaseScholarRemoteDataSource scholarRemoteDataSource;

  HomeRepositoryImpl({
    required this.homeRemoteDataSource,
    required this.bookRemoteDataSource,
    required this.scholarRemoteDataSource,
  });
  @override
  Future<Result<HomeData>> getHomeData() async {
    try {
      ...
      final foreignStudiesResult = await bookRemoteDataSource.getForeignStudies();
